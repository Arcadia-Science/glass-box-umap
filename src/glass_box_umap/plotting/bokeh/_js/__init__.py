...
FEATURE_VIEW_PICKER = (_DIR / "feature_view_picker.js").read_text(encoding="utf-8")
TOP_N_SLIDER = (_DIR / "top_n_slider.js").read_text(encoding="utf-8")
HIERARCHY_UPDATE = (_DIR / "hierarchy_update.js").read_text(encoding="utf-8")
SUBSET_UPDATE = (_DIR / "subset_update.js").read_text(encoding="utf-8")
